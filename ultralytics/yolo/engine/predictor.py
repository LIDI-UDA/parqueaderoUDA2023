...
class BasePredictor:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        # ###MODIFICACION
        # Aqui se apuntan a las variables personalizadas que se crean en model.predict
        # print(f"Hola: {self.args.envio_areas}")
        self.areas = self.args.envio_areas
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        #
        #     # imgR = result.plot(labels=True, conf=True)
        #     imgR = self.plotted_img
        #
    ...
    def stream_inference(self, source=None, model=None):
        ...
        for batch in self.dataset:
            ...
            # MODIFICACIONES
            # ###DESHABILITAR EL LOGGER COMENTANDO LA LINEA LOGGER.INFO
    ...
    def show(self, p):
        ...
        # Modificación para dibujar los círculos de deteccion en las imágenes
        # print(f"hola: {self.areas}")
        areas_dict = self.args.envio_areas.to_dict('records')  # Se pasa a diccionario por ser la forma mas
        # eficiente segun medium
        for fila in areas_dict:  # Recorro todos los puntos de ese cluster
            # pt_cen = list(fila['x_cen_cluster'], fila['y_cen_cluster'])
