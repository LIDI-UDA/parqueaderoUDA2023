...
if __name__ == "__main__":
    ...
    results = model.predict('parqueaderos_uda/imgs_cam1/IMGP1_2023-06-21_09-40-40.jpg',
    ...
    # Variable que ayuda ha asignar el nombre de la imagen a las detecciones del centroide
    cont = 0
