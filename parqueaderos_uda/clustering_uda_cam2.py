...
# Se leen los datos
datos = pd.read_csv('./parqueaderos_uda/park2_uda_detecciones.csv')
...
# Cluster con DBSCAN
dbscan_clustering = DBSCAN(eps=30, min_samples=900).fit(df)
...
# dbscan_dataset.to_csv('labeled_park2_uda_cam2.csv', index=False)
