...
datos = pd.read_csv('./parqueaderos_uda/labeled_park2_uda_cam2.csv')  # labeled_park.csv'
...
# img = cv2.imread('./parqueaderos_uda/imgs_cam2/pk_limpio_cam2.jpg')
img = cv2.imread('./parqueaderos_uda/pk2_vacio_centroides.jpg')
...
# Fn.mostrar("img", img)
cv2.imwrite('park2_uda_cam2_areas_centroides.jpg', img)
...
folder = "./parqueaderos_uda/imgs_cam2"
...
# imagenes
# 'rtsp://admin:@10.10.208.246:554'
# class 7 = truck
# class 5 = bus
# classes=[1, 2, 3, 7]
results = model.predict('rtsp://admin:@10.10.208.246:554',
                        save=False,
                        imgsz=864,
                        conf=0.25,
                        classes=[2, 7, 5],
                        ...
                        agnostic_nms=True,
                        show_conf=False, boxes=True, stream=True, show=True)
# show=True
espacios_disponibles = len(lista_clusters)
aux = []
set_aux = set()
